...
ADVANCED_IMPORT_TARGETS: tuple[ImportTarget, ...] = (
    ...
    ImportTarget("professional", "build", "build"),
    ImportTarget("professional", "duckdb", "duckdb"),
    ImportTarget("professional", "hypothesis", "hypothesis"),
    ImportTarget("professional", "pyarrow", "pyarrow"),
    ImportTarget("professional", "setuptools", "setuptools"),
    ImportTarget("professional", "wheel", "wheel"),
    ImportTarget("sql-notebooks", "jupysql", "sql"),
    ImportTarget("sql-notebooks", "sqlalchemy", "sqlalchemy"),
